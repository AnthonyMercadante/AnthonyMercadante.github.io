...
const style = {
  paragraph: { marginBottom: '1rem', textAlign: 'left' },
  featureHeading: { marginBottom: '1rem' },
};
...
const BattleShipBot = () => {
  return (
    <PageShell
      ...
      eyebrow="Bots / Algorithms & strategy"
  ...
  return (
    <Grid item xs={12}>
      <Typography variant="body1" sx={style.paragraph}>
        The BattleShipBot, is an advanced Battleship game bot designed to play against an opponent
        with strategic precision. This bot utilizes a unique combination of probabilistic and
        targeted strategies to enhance its gameplay, aiming to achieve the lowest average number of
        shots across multiple games on a 10x10 grid.
      </Typography>
      <Typography variant="body1" sx={style.paragraph}>
        Objective: Minimize the number of shots required to sink all enemy ships across 10,000
        games.
      </Typography>
    </Grid>
  );
...
const YourApproach = () => {
  return (
    <Grid item xs={12}>
      ...
      <Typography variant="body1" sx={style.paragraph}>
        BattleShipBot implements a hybrid strategy, integrating both probabilistic and targeted
        approaches. It leverages historical data to make educated guesses in the early game and
        switches to a more focused approach once a ship is hit, targeting specific areas to
        effectively sink ships.
      </Typography>
      <Typography variant="body1" sx={style.paragraph}>
        The bot employs arrays, sets, maps, and priority queues to manage the game state, track ship
        placements, and calculate shot probabilities. This selection of data structures ensures
        efficient data management and optimal decision-making during gameplay.
      </Typography>
    </Grid>
  );
};
...
const TechnicalImplementation = () => {
  return (
    <Grid item xs={12}>
      ...
      <Typography component="div" variant="body1" sx={style.paragraph}>
        One challenge was efficiently managing the probabilistic calculations for shot selection.
        This was solved by using a priority queue to rank cells based on their likelihood of
        containing a ship, significantly optimizing the shot selection process.
        <div>
...
const Results = () => {
  return (
    <Grid item xs={12}>
      ...
      <Typography variant="body1" sx={style.paragraph}>
        The BattleShip bot achieved an impressive average shot count well below the goal target,
        showcasing its effectiveness in strategically playing Battleship. The precise combination of
        algorithms and data structures played a pivotal role in this achievement.
      </Typography>
    </Grid>
  );
};
...
const CodeAccessibility = () => {
  return (
    <Grid item xs={12}>
      ...
      <Typography variant="body1" sx={style.paragraph}>
        Access the complete code for this project via the downloadable ZIP file. This comprehensive
        package contains all the necessary files and documentation to explore and understand the
        BattleShip Bot in detail.
      </Typography>
      <Button
        variant="contained"
        color="primary"
